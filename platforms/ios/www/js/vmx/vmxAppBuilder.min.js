...
function sendtoPipelines(blob) {
    ...
    var url = "http://cyclopus.blippar.com/api/ltu/json/#"+Math.random();
...
angular.module("vmx.services", []).value("REMOTE_URL", "https://models.vision.ai").value("VMX_USER", {
    ...
    b.otherwise("/"), a.state("home", {
        url: "/",
        templateUrl: "./_static/partial/home.html"
    }).state("models", {
        url: "http://cyclopus.blippar.com/vmx/models",
        templateUrl: "./_static/partial/models.html"
    }).state("sessions", {
        url: "http://cyclopus.blippar.com/vmx/sessions",
        templateUrl: "./_static/partial/sessions.html"
    })
}]), angular.module("vmx.services").constant("vmx_version", "vmxAppBuilder_v0.1.13");
var vmxApi, VmxApi;
! function() {
    "use strict";
    var a, b = !1,
    ...
    if (this.fillStyle = b, this.ilearn_class && 0 !== this.ilearn_class && (a.lineWidth = 0, a.fillStyle = 1 === this.ilearn_class ? "rgba(0,255,0,0.15)" : "rgba(255,0,0,0.15)", a.fillRect(this.x, this.y, this.w, this.h)), a.fillStyle = b, a.lineWidth = this.line_width, a.strokeStyle = b, a.strokeRect(this.x, this.y, this.w, this.h), this.line_width > 1 && this.name) {
        ...
        var d = a.measureText(c).width + this.line_width,
            e = 10;
        a.fillRect(this.x - this.line_width / 2, this.y - e - this.line_width / 2 + 1, d, e), a.fillStyle = "rgb(0,0,0)", a.fillText(c, this.x, this.y - a.lineWidth)
    }
    a.restore()
};
var GridTracker;
...
! function() {
    ...
    var c = [],
        d = "http://cyclopus.blippar.com/vmx/session",
        e = function(c) {
            var e = a.defer(),
                f = {};
    ...
    function c(c, d) {
        var e = "http://cyclopus.blippar.com/vmx/session/" + c + "/edit",
            f = {
                changes: [],
                settings: d
            },
    ...
    function d(c, d, e) {
        var f = "http://cyclopus.blippar.com/vmx/session/" + c + "/edit",
            g = {
                settings: d,
                changes: e
            },
    ...
    return n.prototype.set_connection = function(a) {
        ...
        var c = this.params,
            d = "http://cyclopus.blippar.com/vmx/session/" + this.connection.id + "/params",
            e = a.defer();
        return b.get(d).success(function(a) {
        ...
        return void 0 === this.params.crop_mode || this.params.crop_mode === !1 ? !1 : !this.last_response || this.last_response.objects.length > 0 && this.last_response.objects[0].score < this.params.get("crop_threshold") ? !1 : !0
        ...
        var h = this.params.flatten(),
            ...
            j = "http://cyclopus.blippar.com/vmx/session/" + this.connection.id,
            k = {
                images: [i],
                params: h
            },
    ...
    function b() {
        var b = window.innerWidth,
            ...
            g = false,
            h = "http://127.0.0.1:8081/live.jpg",
    ...
    function h(a) {
        var b = "http://127.0.0.1:8081/live.jpg";
        return b
    }
    var i = 200,
        j = function(d, j) {
                    ...
                    return d.is_playing ? (d.startTime = (new Date).getTime(), void a.get(d.src, {
                        ...
                        if (b.Blob && b.URL && b.URL.createObjectURL) {
                            ...
                            g.src = c, g.onload = function() {
                                d.set_image(this)
                                /*
                                var cvs = document.getElementById("dummy");
                                var destCtx = cvs.getContext('2d');
                                destCtx.drawImage(d.img, 0, 0);
                                if(ltuEngine==true) {
                                    var base64scene = cvs.toDataURL('image/jpg');
                                    var binary = dataUriToBlob(base64scene);
                                    var blob = new Blob([binary], {type: 'image/jpg'});
                                    sendtoPipelines(blob);
                                }*/
                            }
    ...
    var e = [],
        f = "http://cyclopus.blippar.com/vmx/model",
        g = function() {
            var c = a.defer();
    ...
    return {
        ...
        create: function(d, e, g, h) {
            ...
            var m = {
                ...
                o = "",
                p = c(function() {
                    b.get("http://cyclopus.blippar.com/vmx/session/" + n + "/log.txt").success(function(a) {
    ...
    var d, e, f, g, h = "https://beta.vision.ai/",
        i = "./_static/enter_license/dist/index.html",
        j = function() {
            var h = b.defer();
            return a.get("http://cyclopus.blippar.com/vmx/check").success(function(a) {
    ...
    return {
        ...
        controller: ["$modal", function(b) {
            ...
            var d = function() {
                    var a = b.open({
                        backdrop: "static",
                        templateUrl: "./_static/partial/vmxCheckLicenseModal.html",
                ...
                e = function() {
                    var a = b.open({
                        templateUrl: "./_static/partial/vmxCheckLicenseProblemModal.html",
                        windowClass: ["vmx-check-license-modal"],
                        controller: ["$scope", "$modalInstance", "vmxCheckLicense", function(a, b, c) {
    ...
    return {
        restrict: "E",
        templateUrl: "./_static/partial/vmxListModelsPanel.html",
        link: function(a, b, c) {
    ...
    return {
        restrict: "E",
        templateUrl: "./_static/partial/vmxListModelsButton.html",
        controller: ["$scope", "$modal", "vmxconnections", "vmxcreatemodel", "vmxconfig", function(a, b, c, d, e) {
            var f = function(a) {
                var c = b.open({
                    templateUrl: "./_static/partial/vmxListModelsModal.html",
                    ...
                    controller: ["$scope", "$modalInstance", function(a, b) {
                        e.pause(), a.choose = function(a, c) {
                            ...
                            var f = a.map(function(a) {
                                return a.url ? 'http://cyclopus.blippar.com/vmx/'+ a.url + "/models/" + a.uuid + "/" + e : a.uuid
                            });
                            b.close({
                                model_uuids: f,
                                compiled: c
    ...
    return {
        restrict: "E",
        templateUrl: "./_static/partial/vmxEditModelButton.html",
        scope: {
            detector: "="
        },
        controller: ["$scope", "$modal", "vmxconfig", function(a, b, c) {
            ...
            a.displayModelEditorModal = function() {
                c.pause();
                var a = b.open({
                    templateUrl: "./_static/partial/vmxEditModelModal.html",
                    windowClass: "vmx-wide-modal",
                    controller: ["$scope", "$modalInstance", function(a, b) {
    ...
    return {
        restrict: "E",
        templateUrl: "./_static/partial/vmxEditModelPanel.html",
        scope: {
            detector: "=",
            cancelfunction: "="
        },
    ...
    return {
        restrict: "E",
        templateUrl: "./_static/partial/vmxSaveModelPanel.html",
        scope: {
            detector: "=",
            cancelfunction: "="
        },
    ...
    return {
        restrict: "E",
        templateUrl: "./_static/partial/vmxSaveModelButton.html",
        scope: {
            detector: "="
        },
        controller: ["$scope", "$modal", "vmxconfig", function(a, b, c) {
            a.open_save_modal = function() {
                ...
                c.pause();
                var e = b.open({
                    templateUrl: "./_static/partial/vmxSaveModelModal.html",
                    controller: ["$scope", "$modalInstance", function(a, b) {
    ...
    return {
        restrict: "E",
        templateUrl: "./_static/partial/vmxListSessions.html",
        link: function(a) {
            a.update()
        },
    ...
    return {
        restrict: "E",
        templateUrl: "./_static/partial/vmxListVideosPanel.html",
    ...
    return {
        ...
        templateUrl: "./_static/partial/vmxAvailableDetectors.html",
    ...
    return {
        restrict: "E",
        templateUrl: "./_static/partial/vmxCreateModel.html",
        link: function(a, b) {
            b.parent().draggable({
                handle: ".dragbar",
                stack: ".dbar"
            }), a.jshint_happy_hack_ = !0
        },
    ...
    return {
        ...
        templateUrl: "./_static/partial/vmxDetectorParam.html",
        link: function(a) {
    ...
    return {
        ...
        templateUrl: "./_static/partial/vmxDetectorParams.html",
        scope: {
            paramsObj: "=params",
            toInclude: "&",
    ...
    return {
        restrict: "E",
        templateUrl: "./_static/partial/vmxDetectorThumbnail.html",
        scope: {
            model: "=model",
    ...
    return {
        restrict: "E",
        templateUrl: "./_static/partial/vmxLearningThumbnail.html",
        scope: {
            model: "=",
            params: "=",
            download: "=",
    ...
    return {
        restrict: "E",
        templateUrl: "./_static/partial/vmxImageCrop.html",
        scope: {
            "class": "=class",
            score: "=score",
            time: "@time",
    ...
    return {
        restrict: "E",
        templateUrl: "./_static/partial/vmxOverlayMenu.html",
    ...
    return {
        restrict: "E",
        templateUrl: "./_static/partial/vmxRunningDetectors.html",
    ...
    return {
        restrict: "E",
        require: "^vmxVideo",
        templateUrl: "./_static/partial/vmxTracker.html",
        link: function(c, d) {
    ...
    return {
        restrict: "E",
        transclude: !0,
        templateUrl: "./_static/partial/vmxVideo.html",
        link: function(a, b, j) {
            ...
            if (a.toId = function(a, b) {
                ...
                console.warn("Cannot setup webcam, status=", b), a.start(), console.log("scope vid is", a.vid), a.vid.src = "./_static/img/w.mp4", a.vid.style.visibility = "visible";
    ...
    return {
        restrict: "E",
        templateUrl: "./_static/partial/vmxCopyrightFooter.html",
