cordova.define("jp.wizcorp.phonegap.plugin.wizCanvasPlugin.wizCanvasPlugin", function(require, exports, module) { /* WizCanvas for cordova - Create a native canvas view.
*
 * @author Ally Ogilvie  
