...
//    {
        NSLog(@"Set preview port to Medium");
...
-(void)addTimerInMainThread
{
    ...
    _inactiveTimer = [NSTimer scheduledTimerWithTimeInterval:480.0 target:self selector:@selector(onInactiveTick:) userInfo:nil repeats:NO];
}
