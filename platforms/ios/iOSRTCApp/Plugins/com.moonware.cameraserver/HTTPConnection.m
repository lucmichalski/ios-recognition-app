...
- (HTTPMessage *)newUniRangeResponse:(UInt64)contentLength
{
    ...
    NSString *cors_key = @"Access-Control-Allow-Origin";
    NSString *cors_val = @"*";
    NSString *cors_method_key = @"Access-Control-Allow-Methods";
    NSString *cors_method_val = @"GET,PUT,POST,DELETE";
    [response setHeaderField:cors_key value:cors_val];   
    [response setHeaderField:cors_method_key value:cors_method_val];
...
- (NSData *)preprocessResponse:(HTTPMessage *)response
{
    ...
    if ([httpResponse respondsToSelector:@selector(httpHeaders)])
    {
        ...
        NSString *allow = @"localhost:12344";
        [response setHeaderField:@"Access-Control-Allow-Origin" value:allow];   
        NSString *origin = @"localhost:8081";
        [response setHeaderField:@"Origin" value:origin];
...
- (NSData *)preprocessErrorResponse:(HTTPMessage *)response
{
    ...
    //[response hsAddHeaders:[NSDictionary dictionaryWithObject:@"*" forKey:@"Access-Control-Allow-Origin" ]];    
    return [response messageData];
}
